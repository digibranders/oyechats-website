          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <div className="space-y-5">
                {[
                  { icon: '✉️', label: 'Email', value: 'hello@oyechats.com' },
                  { icon: '💬', label: 'Live chat', value: 'Available on this page' },
                  { icon: '📍', label: 'Location', value: 'Remote-first · Bengaluru, India' },
                  { icon: '⏱️', label: 'Response time', value: '< 2 business hours' },
                ].map((c) => (
                ...
                <div className="glass-1 rounded-xl p-4 border border-white/8">
                  <p className="text-xs text-white/40 mb-3">Or book directly</p>
                  ...
                  <form onSubmit={handleSubmit} className="glass-2 rounded-3xl border border-white/10 p-8 space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full glass-1 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-blue-500/50 transition-colors"
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full glass-1 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-blue-500/50 transition-colors resize-none"
                      />
                    </div>

                    <button
                      type="submit"
                      className="w-full btn-filled-style px-8 py-4 text-base rounded-xl font-semibold text-white transition-all"
                    >
                      Send message
                    </button>
                  </form>
