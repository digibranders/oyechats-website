...
export const pricingTiers: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      '1,250 URL scans / month',
      '5,000 AI queries / month',
      '2,500 live operator messages / month',
      '1,250 chat summaries by email / month',
      '1,250 email notifications / month',
  ...
  },
  {
    ...
    features: [
      '3,750 URL scans / month',
      '15,000 AI queries / month',
      '7,500 live operator messages / month',
      '3,750 chat summaries by email / month',
      '3,750 email notifications / month',
...
export const featureRows: PricingFeature[] = [
  // Usage
  { label: 'Monthly price', free: 'Free', starter: '$19 / operator', standard: '$57 / operator', enterprise: 'Custom', category: 'usage' },
  { label: 'Annual price (save 30%)', free: '—', starter: '$13/mo ($159/yr)', standard: '$40/mo ($480/yr)', enterprise: 'Contact us', category: 'usage' },
  { label: 'URL scanning', free: '250', starter: '1,250', standard: '3,750', enterprise: 'Unlimited', category: 'usage' },
  { label: 'AI queries', free: '1,250', starter: '5,000', standard: '15,000', enterprise: 'Unlimited', category: 'usage' },
  { label: 'Live operator chat (messages)', free: false, starter: '2,500 msg', standard: '7,500 msg', enterprise: 'Unlimited', category: 'usage' },
  // Features
  { label: 'Chat summaries by email', free: false, starter: '1,250/mo', standard: '3,750/mo', enterprise: 'Unlimited', category: 'features' },
  { label: 'Email message notifications', free: false, starter: '1,250/mo', standard: '3,750/mo', enterprise: 'Unlimited', category: 'features' },
