...
export const featureRows: PricingFeature[] = [
  ...
  { label: 'URL scanning', free: '50', starter: '250', standard: '1,250', enterprise: 'Unlimited', category: 'usage' },
  { label: 'AI queries', free: '250', starter: '1,000', standard: '5,000', enterprise: 'Unlimited', category: 'usage' },
  { label: 'Live operator chat (messages)', free: false, starter: '500 msg', standard: '2,500 msg', enterprise: 'Unlimited', category: 'usage' },
  // Features
  { label: 'Chat summaries by email', free: false, starter: '250/mo', standard: '1,250/mo', enterprise: 'Unlimited', category: 'features' },
  { label: 'Email message notifications', free: false, starter: '250/mo', standard: '1,250/mo', enterprise: 'Unlimited', category: 'features' },
