...
>) {
  ...
  const movingMap: Record<Direction, string> = {
    ...
    BOTTOM: 'radial-gradient(20.7% 50% at 50% 100%, #06B6D4 0%, rgba(255, 255, 255, 0) 100%)',
    RIGHT: 'radial-gradient(16.2% 41.199999999999996% at 100% 50%, #60A5FA 0%, rgba(255, 255, 255, 0) 100%)',
  };

  const highlight = 'radial-gradient(75% 181.15942028985506% at 50% 50%, #2563EB 0%, rgba(255, 255, 255, 0) 100%)';
  ...
  return (
    <div ref={inViewRef} className="contents">
    <TagComponent
    ...
    >
      <div
        className={cn('w-auto text-white z-10 bg-[#030D1F] px-5 py-2 rounded-[inherit]', className)}
      >
        {children}
      </div>
      <motion.div
