    ...
    return (
      <div className="glass-2 rounded-2xl p-6 space-y-4">
        ...
        {[
          ...
          <div key={file.name} className="flex items-center gap-3 glass-1 rounded-xl p-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-white/35">{file.pages} pages</p>
            </div>
        ...
        <div className="pt-2 border-t border-white/8 flex items-center justify-between">
          <span className="text-xs text-white/40">Total indexed</span>
    ...
    return (
      <div className="glass-2 rounded-2xl p-6 space-y-4">
        ...
        <div className="glass-1 rounded-xl px-4 py-3 border border-white/10">
          <p className="text-[10px] text-white/40 mb-1">Bot name</p>
          <p className="text-sm font-medium text-white">Aria from Acme Corp</p>
        </div>
        {/* Welcome message */}
        <div className="glass-1 rounded-xl px-4 py-3 border border-white/10">
          <p className="text-[10px] text-white/40 mb-1">Welcome message</p>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-1.5">
              <span className="text-[10px] bg-emerald-500/15 text-emerald-400 border border-emerald-500/25 rounded-full px-2 py-0.5">Sales Ready</span>
            </div>
          </div>
        </div>
        {/* Webhook fired */}
        <div className="glass-1 rounded-xl p-3 border border-emerald-500/20">
          <p className="text-[10px] text-emerald-400 font-medium mb-1">✓ Webhook fired</p>
          <p className="text-[10px] font-mono text-white/40">POST /tier_transition → 200 OK 43ms</p>
        </div>
        {/* CRM notification */}
        <div className="glass-1 rounded-xl p-3 border border-blue-500/20">
          <p className="text-[10px] text-blue-400 font-medium mb-1">📧 Email sent to team</p>
          <p className="text-[10px] text-white/40">New Sales-Ready lead: Marcus Chen (Finvault)</p>
        </div>
      </div>
    );
  }
            ...
            {steps.map((step, i) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'w-full text-left rounded-2xl border p-5 transition-all duration-400',
                    isActive
